...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 px-4 py-6 font-inter overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-6 sm:mb-8 text-center text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-500 drop-shadow-lg">
